...
This is the welcome and introduction to DeltaV. Students will meet the campus manager and learn about campus operations and policies.
...
The instructor will give an overview of the topics to be covered in this course and how those topics fit into the overall academic program at DeltaV.
...
- Directory structure: Have students set up a directory at ~/deltav/201/ in which they will store their classwork. Go over directory structure in general; compare to GUI.
